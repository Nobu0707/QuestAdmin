...
QuestAdmin v1.0.4 は ITEM_DELIVERY クエストに対応した v1.0.0 MVP の安定化版です。
Phase 11.5 では作成/編集セッションcleanup、納品対象インベントリの安全化、チャット一覧ページングを追加しています。
...
3. `mods` フォルダへ `questadmin-1.0.4.jar` を入れます。
4. サーバーを起動します。
