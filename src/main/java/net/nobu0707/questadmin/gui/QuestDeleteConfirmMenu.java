...
public final class QuestDeleteConfirmMenu extends ChestMenu {
    ...
    private void refreshConfirmSlots() {
        ...
        if (!service.hasAdminPermission(player)) {
            questContainer.setItem(DETAIL_SLOT, AdminQuestMenuItemFactory.createNoPermissionItem());
            return;
        }
        ...
        if (quest == null) {
            ...
            questContainer.setItem(CANCEL_SLOT, AdminQuestMenuItemFactory.createCancelDeleteItem());
            return;
        }

        questContainer.setItem(DETAIL_SLOT, AdminQuestMenuItemFactory.createDetailItem(quest));
        questContainer.setItem(DELETE_SLOT, AdminQuestMenuItemFactory.createConfirmDeleteItem(quest));
        questContainer.setItem(CANCEL_SLOT, AdminQuestMenuItemFactory.createCancelDeleteItem());
    }
