...
```text
~/servers/forge-1.20.1/mods/questadmin-0.7.0.jar
...
次は **Phase 8：クエスト作成GUI** が候補です。

目的:

- 管理者GUIから新規クエスト作成画面を開く
- アイテム納品クエストの入力フォームを作る
- 入力内容を検証して `quests.json` に保存する

Phase 8までは作成GUI本体、編集GUI、テキスト入力GUIは未実装です。
